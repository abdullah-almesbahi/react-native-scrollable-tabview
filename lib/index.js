...
class ScrollableTabView extends Component {
  ...
  componentDidMount() {
    ...
    this.state.scrollX.addListener(({ value }) => {
      ...
      if (I18nManager.isRTL && Platform.OS === 'android') {
        this.props.onScroll(this._children().length - 1 - scrollValue);
      } else {
  ...
  renderScrollableContent() {
    ...
    return (
      <Animated.ScrollView
        refreshControl={
          (!isContainerScrollView &&
            this.props.pullToRefresh &&
            typeof this.props.pullToRefresh === 'function' && (
              <RefreshControl
                style={this.props.refreshControlStyle || {}}
        ...
        contentOffset={{
          x:
            this._getScrollableContentInitialPage() * this.state.containerWidth,
        }}
